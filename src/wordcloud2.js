      ...
      elements.forEach(function (el) {
        ...
        if (el.getContext) {
          ...
          if (settings.fadeIn) {
            ...
            var alpha = settings.startOpacity;
            ...
            var interval = setInterval(function () {
              ...
              // Update hsl color with alpha user setting (default 1.0).
              ...
              // for clear, https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/measureText
              var textDimensions = ctx.measureText(word);

              // clear previously drawn text (without baseline offset), height is simply the font size.
              ctx.clearRect(info.fillTextOffsetX, (info.fillTextOffsetY), textDimensions.width, fontSize); // x,y,w,h
